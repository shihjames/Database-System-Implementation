...
int main(int argc, char *argv[])
{
    ...
    case 1:
        cout << endl
             << "Test 1: Index - Value pair: Sort by Index:" << endl
             << flush;
        countCorrect = 0;
        ...
        cout << "Compare Sorted Table.." << endl
             << flush;
        {
    ...
    case 2:
        cout << endl
             << "Test 2: Index - Value pair: Sort by Value:" << endl
             << flush;
        countCorrect = 0;
        cout << "Sort a table.." << flush;
        {
    ...
    case 4:
        cout << endl
             << "Test 4: Index - Value pair: Sort previous table with reduced run-length:" << endl
             << flush;
        countCorrect = 0;
        cout << "Sort a table.." << flush;
        {
    ...
    case 6:
        // Given Test Case:
        cout << endl
             << "Test 6: Pre-released test cases with assignment:" << endl
             << flush;
        countCorrect = 0;
        cout << "Initialization.." << flush;
        {
    ...
    case 7:
        cout << endl
             << "Test 7: Sort file by pages:" << endl
             << flush;
        countCorrect = 0;
        {
            // load up the table supplier table from the catalog
    ...
    case 8:
        cout << endl
             << "Test 8: Load a sorted file and sort again:" << endl
             << flush;
        countCorrect = 0;
        cout << "Initialization.." << flush;
        {
    ...
    case 10:
        cout << endl
             << "Test 10: Reduce run size even more:" << endl
             << flush;
        countCorrect = 0;
        cout << "Sort a table.." << flush;
        {
