...
MyDB_TableRecIteratorAlt ::MyDB_TableRecIteratorAlt(MyDB_TableReaderWriter &myParent, MyDB_TablePtr myTableIn,
													int lowPage, int highPageIn) : myParent(myParent)
{
	myTable = myTableIn;
	curPage = lowPage;
	highPage = highPageIn;
...
MyDB_TableRecIteratorAlt ::MyDB_TableRecIteratorAlt(MyDB_TableReaderWriter &myParent, MyDB_TablePtr myTableIn) : myParent(myParent)
{
	myTable = myTableIn;
	curPage = 0;
	highPage = 1999999999;
