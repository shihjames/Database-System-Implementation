...
MyDB_RunQueueIteratorAlt ::MyDB_RunQueueIteratorAlt(function<bool()> comparator, MyDB_RecordPtr lhs, MyDB_RecordPtr rhs) : pq(IteratorComparator(comparator, lhs, rhs))
{
	firstTime = true;
}
